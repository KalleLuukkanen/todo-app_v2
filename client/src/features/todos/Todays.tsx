...
function Todays({ todoList, sort, categoryFilter, completionFilter }: { todoList: TodoType[], sort: string | null, categoryFilter: string | null, completionFilter: string | null }) {
